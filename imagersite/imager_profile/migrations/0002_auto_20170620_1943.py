# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-20 19:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='imagerprofile',
            name='camera_type',
            field=models.CharField(choices=[('iphone', 'iphone'), ('SamSung', 'SamSung'), ('Nikon', 'Nikon'), ('Canon', 'Canon')], default='iphone', max_length=25, null=True),
        ),
        migrations.AlterField(
            model_name='imagerprofile',
            name='job',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('Color', 'Color'), ('Black and White', 'Black and White'), ('Portrait', 'Portrait'), ('Landscape', 'Landscape')], default='color', max_length=25, null=True),
        ),
        migrations.AlterField(
            model_name='imagerprofile',
            name='social_status',
            field=models.CharField(choices=[('Peasant', 'Peasant'), ('Royalty', 'Royalty'), ('Merchant', 'Merchant'), ('Scholar', 'Scholar')], default='peasant', max_length=25, null=True),
        ),
    ]
